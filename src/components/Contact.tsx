...
import { Mail, MapPin, Phone, Send, CheckCircle, MessageCircle, Sparkles } from "lucide-react";
...
const Contact = () => {
  ...
  // ✅ EMAILJS-INTEGRATED HANDLE SUBMIT
  const handleSubmit = async (e: React.MouseEvent) => {
    ...
    try {
      await emailjs.send(
        "service_opbjzfo",        // Your Service ID
      ...
      alert("Something went wrong. Message could not be sent.");
    }
